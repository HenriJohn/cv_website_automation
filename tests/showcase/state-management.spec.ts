...
test.describe('Test Showcase - State Management', { tag: '@showcase_stable' }, () => {
  ...
  test('verify counter increments correctly', async ({ page }) => {
  ...
  test('verify counter decrements correctly', async ({ page }) => {
  ...
  test('verify counter can go negative', async ({ page }) => {
    // Start at 0
    const initialValue = await showcasePage.getCounterValue();
    expect(initialValue).toBe('0');
  ...
  test('verify reset button resets counter to zero', async ({ page }) => {
    // Increment counter
  ...
  test('verify rapid increment and decrement', async ({ page }) => {
    // Rapidly increment
  ...
  test('verify all buttons are visible and enabled', async ({ page }) => {
